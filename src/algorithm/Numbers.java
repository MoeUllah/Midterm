...
public class Numbers {
	 ...
	 *
	 */
	//I struggled to run the times, but quicksort and mergesort are better. Quicksort is better on average and for integers bucketsort is the best.
	public static void main(String[] args) throws Exception {
			...
			n = num.length;
			randomize (num, n);//By following above, Continue for rest of the Sorting Algorithm....
			algo.mergeSort(num);
			...
			n = num.length;
			randomize (num, n); algo.heapSort(num);
